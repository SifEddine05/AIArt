...
function App() {
  ...
  return (
   <BrowserRouter >
    ...
    <main className=" text-[#000] bg-[#FAEAE9] w-full  px-4  h-screen">
    <header className=" text-[#000] flex justify-between items-center p-3  bg-[#FAEAE9] ">
...
//lg:h-[75px] md:h-[60px] sm:h-[45px] h-[30px]
// lg:h-[calc(100vh-75px)] md:h-[calc(100vh-60px)] sm:h-[calc(100vh-45px)] h-[calc(100vh-30px)]  